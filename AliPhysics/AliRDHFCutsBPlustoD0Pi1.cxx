...
/* $Id: AliRDHFCutsBPlustoD0Pi1.cxx $ */
...
/// \cond CLASSIMP
ClassImp(AliRDHFCutsBPlustoD0Pi1);
/// \endcond



//--------------------------------------------------------------------------
AliRDHFCutsBPlustoD0Pi1::AliRDHFCutsBPlustoD0Pi1(const char* name) :
  AliRDHFCuts(name),
  fTrackCutsSoftPi(0),
  fMaxPtPid(9999.),
  fTPCflag(999.),
...
//--------------------------------------------------------------------------
AliRDHFCutsBPlustoD0Pi1::AliRDHFCutsBPlustoD0Pi1(const AliRDHFCutsBPlustoD0Pi1 &source) :
  AliRDHFCuts(source),
  fTrackCutsSoftPi(0),
...
//--------------------------------------------------------------------------
AliRDHFCutsBPlustoD0Pi1::~AliRDHFCutsBPlustoD0Pi1() {
  //
  // Default Destructor
  //
...
//--------------------------------------------------------------------------
AliRDHFCutsBPlustoD0Pi1 &AliRDHFCutsBPlustoD0Pi1::operator=(const AliRDHFCutsBPlustoD0Pi1 &source)
{
  //
  // assignment operator
  //
...
//--------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::GetCutVarsForOpt(AliAODRecoDecayHF* /*d*/, Float_t* /*vars*/, Int_t /*nvars*/, Int_t* /*pdgdaughters*/) {
  // not yet used

  return;
}
//--------------------------------------------------------------------------
Int_t AliRDHFCutsBPlustoD0Pi1::IsSelected(TObject* obj, Int_t selectionLevel, AliAODEvent* aod, Bool_t bCutArray[68]) {
  //
...
Int_t AliRDHFCutsBPlustoD0Pi1::IsD0FromBPlusSelected(Double_t ptBPlus, TObject* obj, Int_t selectionLevel, AliAODEvent* aod, Bool_t bCutArray[68]) {
  //
...
//----------------------------------------------------------------------------------
Int_t AliRDHFCutsBPlustoD0Pi1::IsD0forD0ptbinSelected(TObject* obj, Int_t selectionLevel, AliAODEvent* aod, Bool_t bCutArray[29]) {
//
...
//--------------------------------------------------------------------------
Int_t AliRDHFCutsBPlustoD0Pi1::IsSelected(TObject* obj, Int_t selectionLevel, AliAODEvent* aod) {
  //
  // In this function we apply the selection cuts on the BPlus candidate and its daughters.
  ...
  if (selectionLevel == AliRDHFCuts::kAll ||
    ...
    nCutIndex = 39;
    cutVariableValue = invMassDifference;
    if(!ApplyCutOnVariable(nCutIndex, ptbin, cutVariableValue)) return 0;
    //---------------------------------------------------------------------
...
//_________________________________________________________________________________________________
Int_t AliRDHFCutsBPlustoD0Pi1::IsD0FromBPlusSelectedMVA(Double_t ptBPlus, TObject* obj, Int_t selectionLevel, AliAODEvent* /*aod*/, AliAODVertex *primaryVertex, Double_t bz) {
  //
  // Apply selection on D0 candidate from BPlus candidate. We have to pass the BPlus candidate to this function to get variables w.r.t. BPlus vertex.
  //
...
//----------------------------------------------------------------------------------
Int_t AliRDHFCutsBPlustoD0Pi1::IsD0forD0ptbinSelectedMVA(TObject* obj, Int_t selectionLevel, AliAODEvent* aod, AliAODVertex *primaryVertex, Double_t bz) {
  //
  ...
  if (selectionLevel == AliRDHFCuts::kAll ||
    ...
    nCutIndex = 0;
    cutVariableValue = invMassDifference;
    if(!ApplyCutOnVariableD0forD0ptbin(nCutIndex, ptbin, cutVariableValue)) return 0;
    //---------------------------------------------------------------------
...
Int_t AliRDHFCutsBPlustoD0Pi1::IsD0SelectedPreRecVtxMVA(AliAODRecoDecayHF2Prong* d, AliAODTrack* pion, AliAODVertex *primaryVertex, Double_t bz, Int_t selLevel = 0)
{
  ...
  if(selLevel == 0 || selLevel == 2 || selLevel == 4){
    ...
    if (pion->Charge() == -1) {
      ...
      if(!ApplyCutOnVariableD0forD0ptbin(0, ptbin, invMassDifference)) returnvalueD0 = -1;
    } else if (pion->Charge() == 1) {
  ...
  if(selLevel == 0 || selLevel == 3){
    ...
    if (ptbin == -1) returnvalueBplus = -1;
      ...
      if(!ApplyCutOnVariable(39, ptbin, invMassDifference)) returnvalueBplus = -1;
    }
  }
...
//----------------------------------------------------------------------------------
Bool_t AliRDHFCutsBPlustoD0Pi1::IsInFiducialAcceptance(Double_t /*pt*/, Double_t y) const
{
  //
...
Int_t AliRDHFCutsBPlustoD0Pi1::IsSelectedPID(AliAODRecoDecayHF* /*obj*/)
{
  //
...
//_______________________________________________________________________________-
Int_t AliRDHFCutsBPlustoD0Pi1::SelectPID(AliAODTrack *track, Int_t type)
{
  //
  //  here the PID
...
//-------------------------------------------------------------------------------------
Double_t AliRDHFCutsBPlustoD0Pi1::DeltaInvMassBPlusKpipi(AliAODRecoDecayHF2Prong * BPlus) const
{
  ///
...
void AliRDHFCutsBPlustoD0Pi1::SetCutsD0forD0ptbin(Int_t nVars, Int_t nPtBins, Float_t **cutsRDD0forD0ptbin) {
  //
  // store the cuts
  //
...
//---------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::SetCutsD0forD0ptbin(Int_t glIndex, Float_t *cutsRDD0forD0ptbin) {
  //
  // store the cuts
  //
...
//---------------------------------------------------------------------------
Int_t AliRDHFCutsBPlustoD0Pi1::PtBinD0forD0ptbin(Double_t pt) const {
  //
...
//---------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::SetPtBinsD0forD0ptbin(Int_t nPtBinLimits, Float_t *ptBinLimits) {
  // Set the pt bins
...
//---------------------------------------------------------------------------
Int_t AliRDHFCutsBPlustoD0Pi1::ApplyCutOnVariable(Int_t nCutIndex, Int_t ptbin, Float_t cutVariableValue, Bool_t bCutArray[68]) {
  ...
  if (GetIsCutUsed(nCutIndex, ptbin) == kTRUE)
  {
    ...
    if (bCut == kTRUE) {
      if(bCutArray) bCutArray[nCutIndex] = 1;
      return 0;
    }
  }
  return 1;
...
//---------------------------------------------------------------------------
Int_t AliRDHFCutsBPlustoD0Pi1::ApplyCutOnVariableD0forD0ptbin(Int_t nCutIndex, Int_t ptbin, Float_t cutVariableValue, Bool_t bCutArray[29]) {
...
//---------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::SetVarNamesD0forD0ptbin(Int_t nVars, TString *varNames, Bool_t *isUpperCut) {
...
//---------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::InitializeCuts() {
...
//---------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::SetCut(Int_t nCutIndex, Int_t ptBin, AliRDHFCutsBPlustoD0Pi1::EUpperCut cutDirection, Float_t cutValue) {
...
//---------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::SetCutD0forD0ptbin(Int_t nCutIndex, Int_t ptBin, AliRDHFCutsBPlustoD0Pi1::EUpperCut cutDirection, Float_t cutValue) {
  // Set the cut value and direction
...
//---------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::InitializeCutsForCutOptimization(Int_t nCutsForOptimization, Int_t nVariables) {
  //
...
//---------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::SetCutsForCutOptimization(Int_t glIndex, Float_t *cutsRDForCutOptimization) {
  //
  // store the cuts
  //
...
//---------------------------------------------------------------------------
void AliRDHFCutsBPlustoD0Pi1::SetCutForCutOptimization(Int_t nCutIndex, Int_t nVariable, Int_t ptBin, AliRDHFCutsBPlustoD0Pi1::EUpperCut cutDirection, Float_t * cutValues) {
  // Set the cut value and direction
