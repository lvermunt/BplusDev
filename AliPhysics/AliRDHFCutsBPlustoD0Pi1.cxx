...
//
  ...
  //Fix if there is a mismatch (fGetCutInfo = true, and bCutArray not initialized in function argument)
  if(fGetCutInfo && !bCutArray){
    Bool_t bCutArray2[29]; bCutArray = bCutArray2;
    for(int i = 0; i < 29; i++){ bCutArray[i] = false; }
  }
