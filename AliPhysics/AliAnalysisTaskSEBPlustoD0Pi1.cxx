...
//
//
//             Cuts are centralized in AliRDHFCutsBPlustoD0Pi1
...
#include "AliRDHFCutsBPlustoD0Pi1.h"
#include "AliStack.h"
...
#include "AliAnalysisTaskSEBPlustoD0Pi1.h"
...
/// \cond CLASSIMP
ClassImp(AliAnalysisTaskSEBPlustoD0Pi1);
/// \endcond

//__________________________________________________________________________
AliAnalysisTaskSEBPlustoD0Pi1::AliAnalysisTaskSEBPlustoD0Pi1():
  AliAnalysisTaskSE(),
  fEvents(0),
  fUseMCInfo(kFALSE),
  fShowMask(0),
...
AliAnalysisTaskSEBPlustoD0Pi1::AliAnalysisTaskSEBPlustoD0Pi1(const Char_t* name, AliRDHFCutsBPlustoD0Pi1* cuts) :
  ...
  fMotherHistogramArrayExtra()
{
  ...
  Info("AliAnalysisTaskSEBPlustoD0Pi1", "Calling Constructor");
...
AliAnalysisTaskSEBPlustoD0Pi1::~AliAnalysisTaskSEBPlustoD0Pi1() {
  ...
  /// destructor
  //
  Info("~AliAnalysisTaskSEBPlustoD0Pi1", "Calling Destructor");
...
void AliAnalysisTaskSEBPlustoD0Pi1::Init() {
  //
  /// Initialization
  //

  if (fDebug > 1) printf("AliAnalysisTaskSEBPlustoD0Pi1::Init() \n");

  return;
}
//_________________________________________________
void AliAnalysisTaskSEBPlustoD0Pi1::UserExec(Option_t *) {
...
void AliAnalysisTaskSEBPlustoD0Pi1::Terminate(Option_t*) {
...
//___________________________________________________________________________
void AliAnalysisTaskSEBPlustoD0Pi1::UserCreateOutputObjects() {
  /// output
  ...
  AliRDHFCutsBPlustoD0Pi1* copyfCuts = new AliRDHFCutsBPlustoD0Pi1(*fCuts);
  // Post the data
...
void  AliAnalysisTaskSEBPlustoD0Pi1::DefineHistograms() {
  /// Create histograms
...
//-------------------------------------------------------------------------------------
AliAODVertex* AliAnalysisTaskSEBPlustoD0Pi1::RecalculateVertex(const AliVVertex *primary, TObjArray *tracks, Double_t bField, Double_t dispersion) {
  //
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::BPlustoD0PiSignalTracksInMC(TClonesArray * mcTrackArray, AliAODEvent*  /*aodevent*/, TMatrix * BPlustoD0PiLabelMatrix, TList *listout) {
...
//-------------------------------------------------------------------------------------
Bool_t AliAnalysisTaskSEBPlustoD0Pi1::D0FirstDaughterSelection(AliAODTrack* aodTrack, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, AliAODMCHeader * header) {
...
//-------------------------------------------------------------------------------------
Bool_t AliAnalysisTaskSEBPlustoD0Pi1::D0SecondDaughterSelection(AliAODTrack* aodTrack, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, AliAODMCHeader * header) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::BPlusPionSelection(AliAODEvent* aodEvent, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, AliAODMCHeader * header) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::D0Selection(AliAODEvent* aodEvent, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, TClonesArray * D0TracksFromFriendFile, AliAODMCHeader * header) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::BPlusSelection(AliAODEvent* aodEvent, AliAODVertex *primaryVertex, Double_t bz, TClonesArray * mcTrackArray, TMatrix * BPlustoD0PiLabelMatrix, TClonesArray * D0TracksFromFriendFile, AliAODMCHeader * header) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::FillFinalTrackHistograms(AliAODRecoDecayHF2Prong * selectedBPlus, AliAODVertex *primaryVertex, Double_t bz, Bool_t isDesiredCandidate, TClonesArray * mcTrackArray) {
...
//-------------------------------------------------------------------------------------
Double_t AliAnalysisTaskSEBPlustoD0Pi1::DeltaInvMassBPlusKpipi(AliAODRecoDecayHF2Prong * BPlus) const
{
  ///
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::FillD0Histograms(AliAODRecoDecayHF2Prong * selectedMother, AliAODVertex *primaryVertex, Double_t bz, Int_t motherType, Int_t histType, Int_t pdgCodeMother) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::FillBPlusHistograms(AliAODRecoDecayHF2Prong * selectedMother, AliAODVertex *primaryVertex, Double_t bz, Int_t motherType, Int_t histType) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::TwoTrackCombinationInfo(AliExternalTrackParam * firstTrack, AliExternalTrackParam * secondTrack, AliAODVertex * primaryVertex, Double_t bz, Bool_t isDesiredCandidate, TString histogram_name, UInt_t prongs[2]) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::ThreeTrackCombinationInfo(AliExternalTrackParam * firstTrack, AliExternalTrackParam * secondTrack, AliExternalTrackParam * thirdTrack, AliAODVertex * primaryVertex, Double_t bz, Bool_t isDesiredCandidate, TString histogram_name, UInt_t prongs[3]) {
...
//-------------------------------------------------------------------------------------
Int_t AliAnalysisTaskSEBPlustoD0Pi1::MatchCandidateToMonteCarlo(Int_t pdgabs, AliAODRecoDecayHF2Prong * candidate, TClonesArray *mcArray, TMatrix * BPlustoD0PiLabelMatrix) const
{
  //
...
//-------------------------------------------------------------------------------------
Int_t AliAnalysisTaskSEBPlustoD0Pi1::IsTrackInjected(AliAODTrack *part, AliAODMCHeader *header, TClonesArray *arrayMC) {
...
//-------------------------------------------------------------------------------------
Bool_t AliAnalysisTaskSEBPlustoD0Pi1::IsCandidateInjected(AliAODRecoDecayHF2Prong *selectedBPlus, AliAODMCHeader *header, TClonesArray *arrayMC) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::CutOptimizationLoop(Int_t variable, Int_t nVariables, Int_t nCuts, Int_t ptBin, Int_t fillNumber, Bool_t isDesiredCandidate) {
...
//-------------------------------------------------------------------------------------
void AliAnalysisTaskSEBPlustoD0Pi1::CutOptimizationVariableValues(AliAODRecoDecayHF2Prong * candidateBPlus, AliAODEvent*  aod) {
