#ifndef AlIRDHFCUTSBPlustoD0Pi1_H
#define AlIRDHFCUTSBPlustoD0Pi1_H
/* Copyright(c) 1998-2010, ALICE Experiment at CERN, All rights reserved. *
 * See cxx source for full Copyright notice                               */

///***********************************************************
/// \class Class AliRDHFCutsBPlustoD0Pi1
...
class AliRDHFCutsBPlustoD0Pi1 : public AliRDHFCuts
{
 public:
  ...
  AliRDHFCutsBPlustoD0Pi1(const char* name="BPlustoD0PiCuts");
  
  virtual ~AliRDHFCutsBPlustoD0Pi1();

  AliRDHFCutsBPlustoD0Pi1(const AliRDHFCutsBPlustoD0Pi1& source);
  AliRDHFCutsBPlustoD0Pi1& operator=(const AliRDHFCutsBPlustoD0Pi1& source);
  ...
  void SetCut(Int_t nCutIndex, Int_t ptBin, AliRDHFCutsBPlustoD0Pi1::EUpperCut cutDirection, Float_t cutValue);
  void SetCutD0forD0ptbin(Int_t nCutIndex, Int_t ptBin, AliRDHFCutsBPlustoD0Pi1::EUpperCut cutDirection, Float_t cutValue);
  void SetCutForCutOptimization(Int_t nCutIndex, Int_t nVariable, Int_t ptBin, AliRDHFCutsBPlustoD0Pi1::EUpperCut cutDirection, Float_t * cutValues);
 ...
 protected:
  ...
  /// \cond CLASSIMP    
  ClassDef(AliRDHFCutsBPlustoD0Pi1,3) ///
  /// \endcond
};
